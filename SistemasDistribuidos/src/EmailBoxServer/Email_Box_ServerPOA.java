...
/**
 * EmailBoxServer/Email_Box_ServerPOA.java . Generated by the IDL-to-Java
...
public abstract class Email_Box_ServerPOA extends
		org.omg.PortableServer.Servant implements
		EmailBoxServer.Email_Box_ServerOperations,
	...
	public Email_Box_Server _this() {
		return Email_Box_ServerHelper.narrow(super._this_object());
	}

	public Email_Box_Server _this(org.omg.CORBA.ORB orb) {
		return Email_Box_ServerHelper.narrow(super._this_object(orb));
	}
