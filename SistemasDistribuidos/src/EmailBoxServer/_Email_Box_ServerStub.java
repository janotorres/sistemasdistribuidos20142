...
/**
 * EmailBoxServer/_Email_Box_ServerStub.java . Generated by the IDL-to-Java
...
public class _Email_Box_ServerStub extends org.omg.CORBA.portable.ObjectImpl
		implements EmailBoxServer.Email_Box_Server {

	public void saveEmail(int userId, String toEmail, String messageEmail) {
		org.omg.CORBA.portable.InputStream $in = null;
		try {
			org.omg.CORBA.portable.OutputStream $out = _request("saveEmail",
					true);
	...
	public EmailBoxServer.Email[] getEmails(int userId, String date) {
		org.omg.CORBA.portable.InputStream $in = null;
		try {
			org.omg.CORBA.portable.OutputStream $out = _request("getEmails",
					true);
			$out.write_long(userId);
			$out.write_string(date);
			$in = _invoke($out);
			EmailBoxServer.Email $result[] = EmailBoxServer.EmailsHelper
					.read($in);
			return $result;
		} catch (org.omg.CORBA.portable.ApplicationException $ex) {
			$in = $ex.getInputStream();
	...
	private static String[] __ids = { "IDL:EmailBoxServer/Email_Box_Server:1.0" };
