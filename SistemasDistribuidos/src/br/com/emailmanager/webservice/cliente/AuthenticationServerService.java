    ...
    extends Service
{
    ...
    private final static Logger logger = Logger.getLogger(br.com.emailmanager.webservice.cliente.AuthenticationServerService.class.getName());

    static {
        URL url = null;
        try {
            URL baseUrl;
            baseUrl = br.com.emailmanager.webservice.cliente.AuthenticationServerService.class.getResource(".");
    ...
    public AuthenticationServerService() {
        super(AUTHENTICATIONSERVERSERVICE_WSDL_LOCATION, new QName("http://webservice.emailmanager.com.br/", "AuthenticationServerService"));
    }
