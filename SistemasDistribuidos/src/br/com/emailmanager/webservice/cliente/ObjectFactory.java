 ...
 * element interface generated in the br.com.emailmanager.webservice.cliente
 * package.
 * <p>
...
public class ObjectFactory {
	...
	private final static QName _AuthenticateResponse_QNAME = new QName(
			"http://webservice.emailmanager.com.br/", "authenticateResponse");
	private final static QName _SendEmail_QNAME = new QName(
			"http://webservice.emailmanager.com.br/", "sendEmail");
	private final static QName _SendEmailResponse_QNAME = new QName(
			"http://webservice.emailmanager.com.br/", "sendEmailResponse");
	private final static QName _Authenticate_QNAME = new QName(
			"http://webservice.emailmanager.com.br/", "authenticate");

	/**
	 * Create a new ObjectFactory that can be used to create new instances of
	 * schema derived classes for package:
	 * br.com.emailmanager.webservice.cliente
	 * 
	 */
	...
	/**
	 * Create an instance of {@link JAXBElement }{@code <}{@link SendEmail }
	 * {@code >}
	 * 
	 */
	...
	public JAXBElement<SendEmail> createSendEmail(SendEmail value) {
		return new JAXBElement<SendEmail>(_SendEmail_QNAME, SendEmail.class,
				null, value);
	}

	/**
	 * Create an instance of {@link JAXBElement }{@code <}
	 * {@link SendEmailResponse }{@code >}
	 * 
	 */
	@XmlElementDecl(namespace = "http://webservice.emailmanager.com.br/", name = "sendEmailResponse")
	public JAXBElement<SendEmailResponse> createSendEmailResponse(
			SendEmailResponse value) {
		return new JAXBElement<SendEmailResponse>(_SendEmailResponse_QNAME,
				SendEmailResponse.class, null, value);
	}
